...
import com.ggr3ml1n.moretech50.api.auth.ApiKeyAuth
...
import com.ggr3ml1n.moretech50.api.infrastructure.Serializer.kotlinxSerializationJson
...
class ApiClient(
    ...
    companion object {
        @JvmStatic
        protected val baseUrlKey = "com.ggr3ml1n.moretech50.api.baseUrl"

        @JvmStatic
        val defaultBasePath: String by lazy {
            System.getProperties().getProperty(baseUrlKey, "http://locahost:8080")
        }
    }
}
